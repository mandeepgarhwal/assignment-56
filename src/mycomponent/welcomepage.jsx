     ...
     return(   
        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary">
            <div className="container-fluid">
                <Link className="navbar-brand" style={{color : "white", backgroundColor : "green", borderRadius : "30px", padding: "10px"}} to="/">IITIAN CLASSES</Link>
      ...
      {/* <ul className="navbar-nav me-auto mb-2 mb-lg-0" /> */}
            { currentrole? (
              ...
              <li className="nav-item" style={{listStyle : "none", fontSize: "20px", paddingLeft : "5px", paddingRight : "5px", paddingTop : "3px"}}>
               ...
               <li className="nav-item" style={{listStyle : "none", fontSize: "20px", paddingLeft : "5px", paddingRight : "5px", paddingTop : "3px"}}>
                 <Link className="nav-link" to="/yourwork">
                    Your works
                   </Link>
               </li>
               {/* <li className="nav-item" style={{listStyle : "none", fontSize: "20px", paddingLeft : "5px", paddingRight : "5px", paddingTop : "3px"}}>
